...
import tech.mude.mude.spotify.CredentialsHandler;
...
public class LoginActivity extends Activity {
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            switch (response.getType()) {
                ...
                case TOKEN:
                    ...
                    startMoodActivity(response.getAccessToken());
                    break;
    ...
    private void startMoodActivity(String token) {
